...
export default function ChatScreen() {
  // Params kan være string eller string[] – coercion helper:
  const raw = useLocalSearchParams<{
    threadId?: string | string[];
    postId?: string | string[];
    otherUserId?: string | string[];
  }>();
  const threadId = Array.isArray(raw.threadId) ? raw.threadId[0] : raw.threadId;
  const postId = Array.isArray(raw.postId) ? raw.postId[0] : raw.postId;
  const otherUserId = Array.isArray(raw.otherUserId) ? raw.otherUserId[0] : raw.otherUserId;
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // Titel (fra join eller fallback fetch)
  ...
  // Auto-scroll når der kommer nye beskeder
  useEffect(() => {
